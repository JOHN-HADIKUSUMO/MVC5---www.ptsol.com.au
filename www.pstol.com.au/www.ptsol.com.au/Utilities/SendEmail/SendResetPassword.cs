...
{
    public class SendResetPassword:Base
    {
        ...
        public SendResetPassword():base()
        {
            mailPriority = MailPriority.High;
            isHTML = true;
        }

        public SendResetPassword(ILibraries libraries, string username,string token)
            : base()
        {
        ...
        public override void Send()
        {
            ...
            StringBuilder subject = new StringBuilder(resourceManager.GetString("ResetPasswordSubject"));
            StringBuilder body = new StringBuilder(resourceManager.GetString("ResetPasswordBody"));
            ...
            body = body.Replace("[!--url--!]", ConfigurationManager.AppSettings["httpBaseURL"].ToString() + ":" + ConfigurationManager.AppSettings["httpBasePort"].ToString() + "/account/new-password/confirm/" + this.username + "/" + this.token);
