...
namespace www.ptsol.com.au.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController()
            : this(new UserManager<ptsolUser>(new UserStore<ptsolUser>(new ptsolDBContext())),new RoleManager<IdentityRole>(new RoleStore<IdentityRole>(new ptsolDBContext())))
        {
        }

        public AccountController(UserManager<ptsolUser> userManager,RoleManager<IdentityRole> roleManager)
        {
